...
class JewishDate(object):
    ...
    def __init__(self, year, month, day):
        ...
        Modified: (Moshe Schorr:) dates are now forced to Adar II in non-leap years.
        ...
        if not self.isLeapYear and self.month == 6:
            self.month = 7

    # Modification - Moshe Schorr:
    # comparisons:
    # Note: EQ assumes Adar II != Adar I, initialize function is now safe for this.
    ...
    # allow subtraction as timedelta
    ...
    # Shabbos method
    def getShabbos (self):
        """Return upcoming Shabbos as a jewish date.
